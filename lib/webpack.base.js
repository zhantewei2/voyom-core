...
const BaseConfig=({
  ...
  templateConditional= {},
  jsRuleInclude=[],
  preconditionLoaders=undefined
})=>{
  // implementation dart-sass
  Object.assign(sassOptions,{implementation:require("sass")});

  preconditionLoaders=preconditionLoaders||[{
    loader:"ifdef-loader",options: templateConditional
  }];
      ...
      rules: [
        {
          ...
          include: jsRuleInclude.concat(/@ztwx/,/@voyo/),
          use:[
